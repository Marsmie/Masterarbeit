...
if __name__ == "__main__":
    ...
    KIDS_output_ordner = '/net/fohlen13/home/marsmie/Cutouts/'
    global KIDS_bildzuweisung
    KIDS_bildzuweisung = '/net/fohlen13/home/marsmie/Paudels_DWARF_MERGER_in_KIDS'
    ...
    ID = bildzuweisung_data['ID']
    Z = bildzuweisung_data['z']
    Ra_deg = bildzuweisung_data['RAdeg']
    Dec_deg = bildzuweisung_data['DEdeg']
    Image_name = bildzuweisung_data['Name_1']
    Im_Ra_start = bildzuweisung_data['Ra_1']
    Im_Ra_end = bildzuweisung_data['Ra_2']
    Im_Dec_start = bildzuweisung_data['Dec_1']
    Im_Dec_end = bildzuweisung_data['Dec_2']
